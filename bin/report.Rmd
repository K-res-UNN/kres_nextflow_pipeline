...
if (!is.null(lrefinder)) {
  ...
  cat("\\textbf{e) Linezolid Resistens: påvist med LRE-finder}")
  cat("\\vspace{1em}\n")
...
if (!is.null(virulencefinder)) {
    ...
    cat("\\textbf{f) Virulensfaktorer: påvist med VirulenceFinder\\newline}\n")
    cat("\\vspace*{1em}\n")
    cat("\\text{Analysen gjelder bare Enterokokker}\n\n")
